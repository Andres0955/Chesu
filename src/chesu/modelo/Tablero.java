...
import chesu.controlador.ControlReproductor;
import chesu.modelo.excepciones.GeneralException;
...
public class Tablero {
    ...
    private boolean movimientosPgnVacio;
    ...
    public Tablero(ControlReproductor controlReproductor) {
        ...
        this.movimientosPgnVacio = false;
     ...
     */
    private String obtenerMovimientoPgn() throws GeneralException{
        if(movimientosPgn.isEmpty()){
            movimientosPgnVacio = true;
            throw new GeneralException("No hay mas movimientos para reproducir.");
        }
    ...
    private Movimiento analizarMovimiento(String notacion) {
        ...
        if (notacion.equals("O-O")){
            ...
            controlReproductor.obtenerInformacion("Kingside Castling!");
            ...
            controlReproductor.obtenerInformacion("Queenside Castling!");
        ...
        controlReproductor.obtenerInformacion(infoJugada);
    ...
    private boolean moverPieza(Movimiento movimiento) {
        ...
        controlReproductor.errorEncontrado(tipoPieza);
        return false;
    }
    ...
    private int[] convertirNotacionACoordenadas(String casilla){
        ...
        System.out.println(fila + " "+ columna + " " + columnaOrigen);
    ...
    public boolean getMovimientosPgnVacio(){
        return movimientosPgnVacio;
    }
}